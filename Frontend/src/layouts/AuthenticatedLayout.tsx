...
const AuthenticatedLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-50 overflow-hidden transition-colors duration-300">
      {/* Overlay for mobile */}
      {sidebarOpen && (
        <div
      ...
      <div className="relative flex flex-1 flex-col overflow-hidden min-h-screen">
